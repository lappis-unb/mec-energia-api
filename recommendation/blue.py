...
class BluePercentileCalculator():
    ...
    PERCENTILE_HEADERS = ['peak_demand_in_kw', 'off_peak_demand_in_kw',
    ...
    def __calculate_percentiles(self):
        ...
        for p in self.PERCENTILES:
            ...
            percentiles[p_str].exceeded_peak_demand_in_kw = \
                self.consumption_history.peak_measured_demand_in_kw \
                - percentiles[p_str].peak_demand_in_kw
    ...
    def __calculate_summary(self, percentiles: 'dict[str, DataFrame]'):
        ...
        summary.exceeded_peak_demand_in_kw = \
            (self.consumption_history.peak_measured_demand_in_kw - summary.peak_demand_in_kw).clip(0)
